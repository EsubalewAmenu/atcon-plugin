...
class DS_Admin_portfolios
{
    ...
    function ds_portfolio_post_type_registration_init()
    {
        $labels = array(
            'name'                  => _x('Portfolio', 'Post type general name', 'general_plugin'),
            'singular_name'         => _x('Portfolio', 'Post type singular name', 'general_plugin'),
            'menu_name'             => _x('Portfolio', 'Admin Menu text', 'general_plugin'),
            'name_admin_bar'        => _x('Portfolio', 'Add New on Toolbar', 'general_plugin'),
            ...
            'featured_image'        => _x('Portfolio Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'general_plugin'),
            ...
            'archives'              => _x('Portfolio archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'general_plugin'),
            ...
            'items_list_navigation' => _x('Portfolio list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'general_plugin'),
            'items_list'            => _x('Portfolio list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'general_plugin'),
        );
        $args = array(
            'labels'             => $labels,
